...
public class BookingController {
    ...
    public ResponseEntity<Object> approveBooking(@RequestHeader("X-Sharer-User-Id") Long userId,
        ...
        log.info("Gateway: подтверждаем бронь {}, userId={}, approved={}", bookingId, userId, approved);
    ...
    public ResponseEntity<Object> getOwnerBookings(@RequestHeader("X-Sharer-User-Id") long ownerId,
        ...
        BookingState state = BookingState.from(stateParam)
                .orElseThrow(() -> new IllegalArgumentException("Unknown state: " + stateParam));
        log.info("Get bookings by owner with state {}, ownerId={}, from={}, size={}", stateParam, ownerId, from, size);
